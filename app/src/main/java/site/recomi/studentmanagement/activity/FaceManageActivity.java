...
import site.recomi.studentmanagement.widget.ProgressDialog;
...
public class FaceManageActivity extends AppCompatActivity {
     ...
     * 下载人脸图片
     * */
    public void downloadFaces(View view) {
        ...
        Request request=new Request.Builder()
                .get()
                .url("http://recomi.site/license_pic/.jpg")
                .build();
...
//                File file=new File("/sdcard/arcfacedemo/register/picture.jpg");
//                file.createNewFile();
//                //创建文件输出流对象用来向文件中写入数据
